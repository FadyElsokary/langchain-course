...
def main():
    ...
    # we run them in pipeline means the summary_prompt_template then pass it to LLM
    chain = summary_prompt_template | llm 

    # This is very important "invoke" which searches for "information"  and be same as {information} im the template 
    # to be the final prompt that we send to the LLM
